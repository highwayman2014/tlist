...
Процедура ПриНачалеРаботыСистемы()
	...
	Если НЕ локОпределитьТекущегоПользователя(глТекущийПользователь, ОписаниеОшибкиОпределенияПользователя) Тогда
	...
	Документы.Задание.ПолучитьФормуСписка().Открыть();
...
//  Нет.
//
Функция локОпределитьТекущегоПользователя(глТекущийПользователь, ОписаниеОшибкиОпределенияПользователя = "") Экспорт
